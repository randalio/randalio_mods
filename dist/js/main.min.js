  ...
  return _createClass(RandalIO_Mods_Main_JS, [{
    ...
    value: function initSwitcher() {
      ...
      switcherButtons.forEach(function (item) {
        item.addEventListener('mouseenter', function () {
          ...
          var allContents = document.querySelectorAll('[id]'); // Or more specific selector
          // Get the target content
          var activeItem = item.getAttribute('data-content');
          var activeContent = document.querySelector("#" + activeItem);
    ...
    value: function initLocoScroll() {
      var scroll = new locomotive_scroll__WEBPACK_IMPORTED_MODULE_1__["default"]({
        ...
        lerp: 0.15,
        // Linear interpolation value - controls smoothness/responsiveness
        multiplier: 0.8,
        // Adjust scroll speed
        scrollFromAnywhere: true,
        // Allow scrolling to start from any point
        smartphone: {
          smooth: true,
          // Enable smooth scrolling on smartphones
