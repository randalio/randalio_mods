...
var RandalIO_Mods_Main_JS = /*#__PURE__*/function () {
  function RandalIO_Mods_Main_JS() {
    _classCallCheck(this, RandalIO_Mods_Main_JS);
    this.init();
  }
  return _createClass(RandalIO_Mods_Main_JS, [{
    key: "init",
    value: function init() {
      var _this = this;
      document.addEventListener('DOMContentLoaded', function () {
        ...
        if (document.readyState === 'complete') {
          _this.initParallax();
          _this.initScrollTrigger();
          _this.initTextReveal();
        } else {
    ...
    value: function initSmoothScroll() {
      ...
      var lenis = new lenis__WEBPACK_IMPORTED_MODULE_1__["default"]({
        autoRaf: true,
        lerp: 0.15,
        wheelMultiplier: 1,
        touchMultiplier: 2,
      ...
      window.lenis = lenis;
      lenis.on('scroll', gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_5__.ScrollTrigger.update);
      gsap__WEBPACK_IMPORTED_MODULE_4__.gsap.ticker.add(function (time) {
        return lenis.raf(time * 1000);
      });
      gsap__WEBPACK_IMPORTED_MODULE_4__.gsap.ticker.lagSmoothing(0);
      document.addEventListener('click', function (e) {
        ...
        if (targetEl) {
          lenis.scrollTo(targetEl, {
            ...
            onComplete: function onComplete() {
              return history.replaceState(null, null, targetId);
            }
          });
        }
      }, {
      ...
      var handlePendingHash = function handlePendingHash() {
        if (window.pendingHash) {
          ...
          if (targetEl) {
            ...
            if ('requestIdleCallback' in window) requestIdleCallback(scrollToHash, {
              timeout: 500
    ...
    value: function initParallax() {
      ...
      var rellaxTargets = _toConsumableArray(document.querySelectorAll("[data-scroll-speed]:not(img), [data-parallax]:not(img), figure.wp-block-image.parallax-img"));
      rellaxTargets.forEach(function (el) {
        var speed = parseFloat(el.dataset.scrollSpeed) || parseFloat(el.dataset.parallaxSpeed) || -2;
        el.classList.add("rellax");
        el.setAttribute("data-rellax-speed", speed);
      });
      if (rellaxTargets.length > 0) {
        this.rellaxInstance = new (rellax__WEBPACK_IMPORTED_MODULE_3___default())(".rellax", {
          center: false,
          vertical: true,
          horizontal: false,
          round: true
        });
        console.log("Rellax initialized on ".concat(rellaxTargets.length, " element(s)."));
      }
      if (window.lenis) {
        var scrollTimeout;
        window.lenis.on("scroll", function () {
          ...
          scrollTimeout = setTimeout(function () {
            var _this2$rellaxInstance;
            (_this2$rellaxInstance = _this2.rellaxInstance) === null || _this2$rellaxInstance === void 0 || _this2$rellaxInstance.refresh();
      ...
      window.addEventListener("resize", function () {
        clearTimeout(resizeTimeout);
        resizeTimeout = setTimeout(function () {
          var _this2$rellaxInstance2;
          (_this2$rellaxInstance2 = _this2.rellaxInstance) === null || _this2$rellaxInstance2 === void 0 || _this2$rellaxInstance2.refresh();
        }, 250);
      });
    ...
    value: function initScrollTrigger() {
      ...
      var pinnedElements = document.querySelectorAll('[data-pin]');
      pinnedElements.forEach(function (element) {
        gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_5__.ScrollTrigger.create({
          ...
          end: "+=".concat(element.dataset.pinDuration || '100%'),
          pin: true,
          pinSpacing: element.dataset.pinSpacing !== 'false',
          onEnter: function onEnter() {
            return element.classList.add('is-pinned');
          },
          onLeave: function onLeave() {
            return element.classList.remove('is-pinned');
          },
      ...
      var horizontalSections = document.querySelectorAll('[data-horizontal-scroll]');
      horizontalSections.forEach(function (section) {
        var wrapper = section.querySelector('.horizontal-wrapper') || section;
        var slides = wrapper.children;
        if (slides.length > 1) {
          gsap__WEBPACK_IMPORTED_MODULE_4__.gsap.to(slides, {
      ...
      var staggerElements = document.querySelectorAll('[data-gsap-stagger]');
      staggerElements.forEach(function (container) {
      ...
      window.addEventListener('resize', function () {
        clearTimeout(resizeTimeout);
        resizeTimeout = setTimeout(function () {
          return gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_5__.ScrollTrigger.refresh();
        }, 250);
      });
    ...
    value: function initTextReveal() {
      ...
      revealElements.forEach(function (element) {
        ...
        var lines = _this3.splitIntoLines(element);
        ...
        lines.forEach(function (line, index) {
          ...
          gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_5__.ScrollTrigger.create({
            ...
            onUpdate: function onUpdate(self) {
              ...
              var totalStagger = (lines.length - 1) * 0.15;
              var adjustedProgress = self.progress * (1 + totalStagger) - staggerDelay;
              var clampedProgress = Math.max(0, Math.min(1, adjustedProgress));

              // Round to reduce sub-pixel flickering
              var roundedProgress = Math.round(clampedProgress * 1000) / 1000;
              line.style.setProperty('--reveal-progress', roundedProgress);
            }
          });
        });
      });
      console.log("Text Reveal initialized on ".concat(revealElements.length, " element(s)"));
    }
  }, {
    key: "splitIntoLines",
    value: function splitIntoLines(element) {
      ...
      container.innerHTML = '';
      var lines = [];
      lineGroups.forEach(function (lineWords, lineIndex) {
    ...
    value: function initSwitcher() {
      var switcherButtons = document.querySelectorAll("[data-content]");
      switcherButtons.forEach(function (button) {
        var targetId = button.getAttribute("data-content");
        var container = button.closest(".content-switcher");
        if (!container) return;
        var panels = container.querySelectorAll(".switch-panel");
        button.addEventListener("mouseenter", function () {
          panels.forEach(function (p) {
            return p.classList.remove("active");
          });
          var target = container.querySelector("#".concat(targetId));
